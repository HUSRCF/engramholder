...
**最新局部复审落实：** [94f1344复审回应](reports/review_followup_94f1344_response_20260925.md)。修正“未确立变化”的否定范围；主表用两种上标区分跨头／跨种子混合后端；三旋转总述限定核心四格，明确OpenFold预设Holm校正，摘要首次定义Factor／G+。1,830字段、204输入不变；3项数值键测试、编译和主表局部视觉检查通过。[当前PDF](build/feedback_v40/paper.pdf)供反馈，最终验收仍留到收尾。
