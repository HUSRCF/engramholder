...
**最新结果整合／反馈版：** [Fresh192与E2完整重训练](reports/fresh192_retraining_integration_20260925.md)。新目标主要Ψ=+0.02515；E2重训练旋转收益保留，但额外缓解T_C=+0.00065、区间跨零。两次执行分开，原1617字段不变。v38匿名包27项测试通过；[当前PDF](build/feedback_v38/paper.pdf)为反馈版，主文结尾在第10页，最终投稿篇幅与全稿验收尚待收尾。
