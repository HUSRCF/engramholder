...
lockpath=Path('notes/writing_branch_20260922/paper_sources.v9.lock.json')
...
for name in ['verify_diamondhill_fourcells.py','diamondhill_paper_assets.py','paper_figure_layouts.py','verify_e1_prediction.py','verify_e2_intervention.py','verify_signed_and_curves.py','completed_controls_assets.py']:
