...
in both the original execution and a same-seed retraining repeat.
Only the original execution establishes a larger compensation gain for
rotated Factor than for Native Factor; the repeat yields a smaller positive
estimate of this gain difference, with a confidence interval that includes zero.
Short paired diagnostic replays show small early numerical drift in training
trajectories; its contribution to the final effect-size difference remains
unresolved (Appendix~\ref{app:e2_repeat}).
