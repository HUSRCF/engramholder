...
| 注入时序、报告阶段 | [第一阶段](openfold_injection_schedule_phase1_20260926.md)7,008轨迹／14,112评分／0失败，261项复算通过；All−First主要交互差未建立，First自身交互保留。只进入MD，未纳入正文、v11或匿名包。 |
| 注入时序、重训练阶段 | 执行侧已恢复72组，第一波36含全部Native与R1，第二波36补R2/R3；本轮只读快照：HPC3校准652881运行，652882正式队列等待校准，HPC2工程12865355_0/1均RUNNING。工程不等于正式放行，最终状态依验收收据；此前36组预算是历史提案。 |
